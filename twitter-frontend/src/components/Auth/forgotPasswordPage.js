...
export default function ForgotPasswordPage() {
    ...
    const handleSubmit = async () => {
        ...
        let url = "http://localhost:4000/api/v1/auth/resetPassword"
        let response
        ...
        if (response.status === 200) {
            setErrMsg(null)
            setNotificationMsg("Reset password email sent!")
        }
            ...
            < form className="forgotPassword-form col-2" onSubmit={handleSubmit}>
                <div className="inner-form">
                    ...
                    <div className="buttons">
                        <button type="submit" onClick={handleSubmit} ><a href="#1">Send Reset Email</a></button>
                    </div>
                    <div className="buttons">
